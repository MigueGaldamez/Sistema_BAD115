      ...
      <thead class="table-dark">
        <tr>
          {data[0] && columns.map((heading) => {
             if(heading!='idmunicipio' && heading!='idestado' && heading!='idpaciente' && heading!='direccion' && heading!='correopaciente' && heading!="fechanacimiento")
          ...
          <tr>
            ...
            return(
                ...
                setNuevoEstado(event.target.value)}}>
                    ...
                    return(  <option  value={estado.idestado}>{estado.estado}</option>)
                    })}
                  </select>
                </td>
              ...
              <a class="btn btn-info btn-sm mx-1" data-bs-toggle="modal" data-bs-target={'#eliminarModal'+id} >Detalles</a>
