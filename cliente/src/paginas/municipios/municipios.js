...
const Municipios = () => { 
  ...
  const agregarRegistro=(event)=>{    
    ...
    Axios.post(`${process.env.REACT_APP_SERVER_IP}/municipios`,{
      //TODOS LOS CAMPOS
      nombre:nombre,
  ...
  const eliminarRegistro=(idmunicipio)=>{
    Axios.delete(`${process.env.REACT_APP_SERVER_IP}/municipios/${idmunicipio}`).then(()=>{
      obtenerRegistros();
      swal({
        title: "Exito!",
  ...
  const actualizaRegistro=(idmunicipio)=>{
    Axios.put(`${process.env.REACT_APP_SERVER_IP}/municipios`,{nombre:nuevoNombre,idmunicipio:idmunicipio,iddepartamento:nuevoIdDepartamento}).then(()=>{
      obtenerRegistros();
      swal({
        title: "Exito!",
