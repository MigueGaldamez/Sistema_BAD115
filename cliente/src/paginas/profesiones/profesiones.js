...
const Profesiones = () => { 
  ...
  const agregarRegistro=(event)=>{    
    ...
    Axios.post(`${process.env.REACT_APP_SERVER_IP}/profesiones`,{
      //TODOS LOS CAMPOS
      nombre:nombre,
    }).then((response)=>{    
  ...
  const eliminarRegistro=(idprofesion)=>{
    Axios.delete(`${process.env.REACT_APP_SERVER_IP}/profesiones/${idprofesion}`).then(()=>{
      obtenerRegistros();
      swal({
        title: "Exito!",
  ...
  const actualizaRegistro=(idprofesion)=>{
    Axios.put(`${process.env.REACT_APP_SERVER_IP}/profesiones`,{nombre:nuevoNombre,idprofesion:idprofesion}).then(()=>{
      obtenerRegistros();
      swal({
        title: "Exito!",
    ...
    <div class="col container my-4">
      ...
      <div class="row bordeLateral mb-3">
        ...
        {validarLista.includes(18) &&
          ...
          <DatatableRoles validarLista={validarLista} data={buscar(profesionLista)} eliminarRegistro={eliminarRegistro} actualizarRegistro={actualizaRegistro} setNuevoNombre={setNuevoNombre}/>
