...
export default function DatatableRoles({validarLista, data,eliminarRegistro,actualizarRegistro,setNuevoNombre,setNuevoEdadMinima,setNuevoEdadMaxima }) {
