...
const Laboratoristas = () => { 
  ...
  const obtenerRegistros=()=>{
    Axios.get('http://localhost:3001/laboratoristas').then((response)=>{
    ...
    Axios.get('http://localhost:3001/usuarioslibres').then((response)=>{
  ...
  const agregarRegistro=(event)=>{    
    ...
    if(nuevoRegistro==true){
      Axios.post('http://localhost:3001/laboratoristas',{
        //TODOS LOS CAMPOS
        nuevo:1,
        nombre:nombre,
        correo:correo,
  ...
  const eliminarRegistro=(idlaboratorista)=>{
    Axios.delete(`http://localhost:3001/laboratoristas/${idlaboratorista}`).then(()=>{
      obtenerRegistros();
      swal({
        title: "Exito!",
  ...
  const actualizaRegistro=(idlaboratorista)=>{
    Axios.put('http://localhost:3001/laboratoristas',{idlaboratorista:idlaboratorista,profesion:nuevaProfesion,usuario:nuevoUsuario,numerojunta:nuevoNumeroJunta}).then(()=>{
      obtenerRegistros();
      swal({
        title: "Exito!",
