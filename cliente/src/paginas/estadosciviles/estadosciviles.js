...
const EstadosCiviles = () => { 
  ...
  const agregarRegistro=(event)=>{    
    ...
    Axios.post(`https://${process.env.REACT_APP_SERVER_IP}/estadosciviles`,{
      //TODOS LOS CAMPOS
      nombre:nombre,
    }).then((response)=>{
  ...
  const eliminarRegistro=(idestado)=>{
    Axios.delete(`https://${process.env.REACT_APP_SERVER_IP}/estadosciviles/${idestado}`).then(()=>{
      obtenerRegistros();
      swal({
        title: "Exito!",
  ...
  const actualizaRegistro=(idestado)=>{
    Axios.put(`https://${process.env.REACT_APP_SERVER_IP}/estadosciviles`,{nombre:nuevoNombre,idestado:idestado}).then(()=>{
      obtenerRegistros();
      swal({
        title: "Exito!",
  ...
  return (
    ...
    <div class="col container my-4">
      ...
      <div class="mt-4 mb-4">
        ...
        <h2 class="m-0"><span>Gestión de Estados Civiles</span>
        {validarLista.includes(30) &&
          ...
          <DatatableRoles validarLista={validarLista} data={buscar(estadoCivilLista)} eliminarRegistro={eliminarRegistro} actualizarRegistro={actualizaRegistro} setNuevoNombre={setNuevoNombre}/>
