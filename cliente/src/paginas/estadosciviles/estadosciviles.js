...
const EstadosCiviles = () => { 
  ...
  const agregarRegistro=(event)=>{    
    ...
    Axios.post(`${process.env.REACT_APP_SERVER_IP}/estadosciviles`,{
      //TODOS LOS CAMPOS
      nombre:nombre,
    }).then((response)=>{
  ...
  const eliminarRegistro=(idestado)=>{
    Axios.delete(`${process.env.REACT_APP_SERVER_IP}/estadosciviles/${idestado}`).then(()=>{
      obtenerRegistros();
      swal({
        title: "Exito!",
  ...
  const actualizaRegistro=(idestado)=>{
    Axios.put(`${process.env.REACT_APP_SERVER_IP}/estadosciviles`,{nombre:nuevoNombre,idestado:idestado}).then(()=>{
      obtenerRegistros();
      swal({
        title: "Exito!",
